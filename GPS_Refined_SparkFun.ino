...
/*
 NOTE: This sketch from sparkfun uses the TinyGPS++ library to refine the GPS string
 Changes from original - GPSBaud increased to 9600
 Sktch uses software serial Pins 2 and 3
